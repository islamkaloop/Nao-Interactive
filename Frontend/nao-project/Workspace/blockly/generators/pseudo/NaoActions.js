...
Blockly.Pseudo['voice_reco'] = function(block) {
  var code = 'Start Voice Recognition (You can order NAO by Voice)\n';
  return code;
};
Blockly.Pseudo['seq_voice_reco'] = function(block) {
  var code = 'Start Voice Recognition (You can order NAO by bunch of command)\n';
  return code;
};
...
Blockly.Python['walk'] = function(block) {
  ...
  if(dropdown_direction== "%{BKY_FORWARD}")
    var code = "Nao.walk("+value_distance+",0)\n";
  else
    var code = "Nao.walk(-"+value_distance+",0)\n";
  return code ;
}; 
Blockly.Python['turn'] = function(block) {
  ...
  var dropdown_direction = block.getFieldValue('direction');
  if(dropdown_direction=="%{BKY_LEFT}")
    var code = "Nao.turn("+angle_angle+")\n";
  else
    var code = "Nao.turn(-"+angle_angle+")\n";
...
Blockly.Python['voice_reco'] = function(block) {
  var code = 'Nao.voiceReco()\n';
  return code;
};

Blockly.Python['seq_voice_reco'] = function(block) {
  var code = 'Nao.seqVoiceReco()\n';
  return code;
};